          ...
          <div style={{ marginTop: 18 }}>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 14, background: "rgba(255,255,255,.04)", padding: 5, borderRadius: 13, border: `1px solid ${COL.borde}` }}>
              <button className="btn" onClick={() => { setTipoLista("entregas"); setBusca(""); }}
                style={{ flex: 1, background: tipoLista === "entregas" ? COL.tinta : "transparent", color: tipoLista === "entregas" ? "#fff" : COL.suave, padding: "10px", fontSize: 14 }}>
                <Package size={16} /> Entregas
              </button>
              <button className="btn" onClick={() => { setTipoLista("traslados"); setBusca(""); }}
                style={{ flex: 1, background: tipoLista === "traslados" ? COL.tinta : "transparent", color: tipoLista === "traslados" ? "#fff" : COL.suave, padding: "10px", fontSize: 14 }}>
        ...
        {vista === "nuevaT" && (
          <div style={{ marginTop: 18, animation: "up .3s both" }}>
            ...
            <div className="card" style={{ padding: 18, display: "grid", gap: 14 }}>
              <div>
                ...
                {usuario.almacen === "Todos" ? (
                  ...
                  <div className="ipt" style={{ display: "flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,.06)", color: COL.suave }}>
                    <Warehouse size={15} /> {usuario.almacen} <span style={{ marginLeft: "auto", fontSize: 11 }}>asignado</span>
                  </div>
                )}
              </div>
              <div>
              ...
              <button className="btn" onClick={guardarTraslado} style={{ background: COL.acento, color: "#fff", padding: "16px", fontSize: 16, marginTop: 4 }}>
        ...
        <div style={{ display: "grid", gap: 10 }}>
          {usuarios.map((u) => (
            <div key={u.id} className="card" style={{ padding: 14, display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <button className="btn" onClick={() => setEditU({ ...u })} style={{ background: "rgba(255,255,255,.04)", color: COL.suave, width: 34, height: 34, borderRadius: 9, border: `1px solid ${COL.borde}` }}><Settings size={15} /></button>
