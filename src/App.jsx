...
import {
  ...
  Warehouse, Bike, Cog, Users, Settings, LogOut, Shield, ChevronDown, FileSpreadsheet, Cloud, CloudOff, Download, SlidersHorizontal
} from "lucide-react";
          ...
          <div style={{ marginTop: 18 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14, gap: 10, flexWrap: "wrap" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: COL.suave, fontWeight: 600 }}>
                ...
                <span style={{ background: "#eceef1", borderRadius: 7, padding: "2px 8px", fontSize: 12 }}>{filtradas.length}</span>
              </div>
              {puede("informes") && (
                <div style={{ position: "relative" }}>
                  <button className="btn" onClick={() => setMenuDescarga((v) => !v)}
                    style={{ background: COL.tinta, color: "#fff", padding: "8px 14px", fontSize: 13 }}>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
              ...
              <button className="btn" onClick={() => setFiltrosAbiertos((v) => !v)}
                style={{ background: filtrosActivos ? COL.acento : "#fff", color: filtrosActivos ? "#fff" : COL.tinta, padding: "0 14px", border: `1.5px solid ${filtrosActivos ? COL.acento : COL.borde}`, flexShrink: 0, position: "relative" }}>
                <SlidersHorizontal size={17} />
                {filtrosActivos > 0 && <span style={{ position: "absolute", top: -6, right: -6, background: COL.tinta, color: "#fff", borderRadius: "50%", width: 18, height: 18, fontSize: 11, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center" }}>{filtrosActivos}</span>}
              </button>
            </div>
